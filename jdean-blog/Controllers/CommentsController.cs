...
namespace jdean_blog.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BlogPostId,AuthorId,Body,CreationDate,UpdatedDate,UpdatedReason")] Comment comment)
        {
        ...
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BlogPostId,AuthorId,Body,CreationDate,UpdatedDate,UpdatedReason")] Comment comment)
        {
            if (ModelState.IsValid)
            {
